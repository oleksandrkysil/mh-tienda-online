...
<template>
  <NuxtLink
    ...
    <NuxtImg
      :width="imgWidth"
      :height="imgHeight"
      class="absolute inset-0 object-cover w-full h-full hover:scale-105 transition-all"
    ...
    <span class="relative z-10 mt-auto mb-2 text-sm font-semibold text-white text-center capitalize md:text-base md:mb-4 truncate w-full p-1 bg-black bg-opacity-50" v-html="node.name" />
  </NuxtLink>
</template>
