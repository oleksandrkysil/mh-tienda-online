import{d as i,J as c,I as p,C as d,c as t,t as l,i as g,o as n}from"./BQsMxEgi.js";const u=i({setup(){const e=c(""),o=c(""),a=c(!0);return p(async()=>{try{const r=await(await fetch("https://next-wp-store.x10.mx/wp/graphql/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:`
              query {
